System.register(["angular2/core"], function (exports_1, context_1) {
    ...
    var core_1, FilterByPropertyPipe;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            FilterByPropertyPipe = (function () {
                ...
                FilterByPropertyPipe.prototype.transform = function (value, filters) {
                    ...
                    return value.filter(function (obj) { return filter(obj, filters[0]); });
                };
                return FilterByPropertyPipe;
            }());
            FilterByPropertyPipe = __decorate([
                core_1.Pipe({ name: 'filterByPropertyPipe' })
            ], FilterByPropertyPipe);
            exports_1("FilterByPropertyPipe", FilterByPropertyPipe);
        }
    };
});
